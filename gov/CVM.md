...
```sh
centaurid tx wasm store "$OUTPOST_WASM_FILE" --from dz --gas=auto -y
centaurid tx wasm instantiate 40 '{"admin": "centauri1u2sr0p2j75fuezu92nfxg5wm46gu22ywfgul6k", "network_id" : 2}' --label "composable_cvm_outpost" --admin centauri1u2sr0p2j75fuezu92nfxg5wm46gu22ywfgul6k --gas=auto --from=dz -y
 
centaurid tx wasm store "$EXECUTOR_WASM_FILE" --from dz --gas=auto -y
```
